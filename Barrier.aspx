<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Barrier.aspx.cs" Inherits="Barrier" %>
		...
		<div id="pageContent">
			<div class="container">
					...
					<aside class="col-md-12 col-lg-12 col-xl-12" id="centerColumn">
						<!-- title -->
						<div class="title-box">
							<h2 class="text-center text-uppercase title-under">Barrier’s</h2>
						</div>
						<!-- /title -->												
                                        ...
                                        <div class="product product--zoom">
                                            <div class="product__inside">
                                                ...
                                                <div class="product__inside__image">
                                                    <a href="product.html">
                                                        <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("hinhanhsp") %> '/>
                                                    </a>
                                                    &nbsp;&nbsp;&nbsp;<!-- quick-view --><a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span>Quick view</b> </a>
                                                    <!-- /quick-view -->
                                                </div>
                                                <!-- /product image -->
                                                <!-- product name -->
                                                ...
                                                <!-- /product description -->
                                                <!-- product price -->
                                                <div class="product__inside__price price-box"> <asp:Label ID="Label2" runat="server" Text='<%# Eval("giasp") %>'></asp:Label> </div>
                                                <!-- /product price -->
                                                <!-- product review -->
                                                <!-- visible only in row-view mode -->
                                                ...
                                                <div class="product__inside__hover">
                                                    ...
                                                    <div class="product__inside__info">
                                                        <div class="product__inside__info__btns">
                                                            <a href="#" class="btn btn--ys btn--xl"><span class="icon icon-shopping_basket"></span>Add to cart</a>
