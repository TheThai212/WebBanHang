<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Maychamcong.aspx.cs" Inherits="Maychamcong" %>
		...
		<div id="pageContent">
			<div class="container">
					...
					<aside class="col-md-12 col-lg-12 col-xl-12" id="centerColumn">
						<!-- title -->
						<div class="title-box">
							<h2 class="text-center text-uppercase title-under">Máy chấm công’s</h2>
						</div>
						<!-- /title -->												
